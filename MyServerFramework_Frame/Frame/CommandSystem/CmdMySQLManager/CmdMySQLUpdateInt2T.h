...
class CmdMySQLUpdateInt2T : public GameCommand
{
	BASE(CmdMySQLUpdateInt2T, GameCommand);
public:
	void reset() override
	{
		mTable = nullptr;
	...
	void execute() override
	{
		...
		{
			mTable->updateIntT(mID, mColumn0, mValue0);
		}
		if (mColumn1 != T::Column::NONE)
		{
			mTable->updateIntT(mID, mColumn1, mValue1);
		}
	}
public:
