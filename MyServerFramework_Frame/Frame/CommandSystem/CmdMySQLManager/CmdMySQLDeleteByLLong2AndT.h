...
class CmdMySQLDeleteByLLong2AndT : public GameCommand
{
	BASE(CmdMySQLDeleteByLLong2AndT, GameCommand);
public:
	void reset() override
	{
		mTable = nullptr;
	...
	{
		mTable->deleteByLLong2AndT(mColumn0, mValue0, mColumn1, mValue1, mOnlyOnce);
	}
public:
